<form action="#" method="POST">
          <div className="shadow sm:overflow-hidden sm:rounded-md">
            <div className="space-y-6 bg-white py-6 px-4 sm:p-6">
              <div>
                <h3 className="text-lg font-medium leading-6 text-gray-900">Title for survey Questions</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Provided copy for Customer Survey.  Provided copy for customer survey. Provided copy for customer survey.
                </p>
              </div>

              <fieldset>
                <legend className="text-base font-medium text-gray-900">Legend Title</legend>
